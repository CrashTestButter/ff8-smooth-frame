...
namespace ff8_world
{
	// Install the world map logic gating + interpolation (needs world_enabled and world_fps).
	void interp_hook_init();
	// True once the hooks are in (the host frame cap may then be raised to world_fps).
